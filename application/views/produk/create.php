      ...
      <div class="card">
        ...
        <?php echo form_open('produk/save')?>
          ...
          <div class="form-group row">
            ...
            <div class="col-8">
              <input id="kode" name="kode" placeholder="Masukkan Kode Produk" type="text" class="form-control">
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-8">
              <input id="stok" name="stok" placeholder="Masukkan Stok Produk" type="text" class="form-control">
            </div>
          </div>
          <div class="form-group row">
